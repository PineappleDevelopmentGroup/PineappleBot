...
import sh.miles.pineapplebot.old.data.PluginComissionTicket;
import sh.miles.pineapplebot.old.data.PluginSetupTicket;
import sh.miles.pineapplebot.old.data.ServerSetupTicket;
...
public class StorageHandler {
    ...
    private void setupHikari() {
        ...
        try (Connection connection = dataSource.getConnection(); Statement statement = connection.createStatement()) {
            ...
            statement.executeUpdate(
                    "CREATE TABLE IF NOT EXISTS text_command_embeds (command TEXT, embed_id INTEGER)"
            );
    ...
    // TODO embed storage, command embed storage
